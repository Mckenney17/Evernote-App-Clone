            ...
            <header>
                ...
                <div className="subheader">
                    ...
                    <div className="notelist-actions" role="toolbar">
                        <button onClick={() => setActiveAction('sort')} className={`sort-notelist ${activeAction === 'sort' ? 'active' : ''}`}>
                        ...
                        <button onClick={() => {console.log(activeAction);setActiveAction('view')}} className={`change-notelist-view ${activeAction === 'view' ? 'active' : ''}`}>
                    ...
                    {activeAction === 'sort'
                    ? <SortActionCard sortActions={sortActions} setSortActions={setSortActions} setActiveAction={setActiveAction} /> : activeAction === 'view'
                    ? <NotelistViewActionCard viewActions={viewActions} setViewActions={setViewActions} setActiveAction={setActiveAction} /> : null}
                </div>
            </header>
