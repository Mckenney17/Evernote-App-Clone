                    ...
                    <React.Fragment key={`tni-${i}`}>
                        {toolName.map((toolNameInner, j) => (
                            <React.Fragment key={`tni-${j}`}>
                                <button className={`${toolNameInner}${toolsState[camelCase(toolNameInner)] === true ? ' active' : ''}`}>{tools.allIcons[i][j]}</button>
                            </React.Fragment>
                        ))}
                        <span className="divider">&nbsp;</span>
                    </React.Fragment>
                    : <React.Fragment key={`tni-${i}`}>
                        <button className={`${toolName}${toolsState[camelCase(toolName)] === true ? ' active' : ''}`}>{tools.allIcons[i]}</button>
                        <span className="divider">&nbsp;</span>
                    </React.Fragment>
                    ))}
                </div>
